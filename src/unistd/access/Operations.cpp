...
Id getRealId() noexcept { return {getuid(), getgid()}; }

Id getEffectiveId() noexcept { return {geteuid(), getegid()}; }
...
void setRealEffectiveSavedId(const Id &real, const Id &effective,
                             const Id &saved) {
